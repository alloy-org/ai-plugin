...
// --------------------------------------------------------------------------
export async function responseTextFromStreamResponse(app, response, aiModel, responseJsonExpected, callback) {
  if (typeof(global.fetch) !== 'undefined') { // isomorphic-fetch from tests
