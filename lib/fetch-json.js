...
//
// Example GET
// fetchJson(CODE_REACTIONS_FETCH_PATH, { payload: { code_line_id: this.props.codeLineId }})
//   .then(json => ...)
//
// Example POSTs
// railsFetchJson(this.props.markFixReleasedPath, { method: "POST", payload: { defect_key: defectParams.defectKey }})
