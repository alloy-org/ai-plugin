import { defaultProviderModel, MODELS_PER_PROVIDER, providerNameFromProviderEm, providerEndpointUrl } from "./constants/provider"
...
async function requestWithRetry(app, model, messages, providerEm, tools, apiKey, promptKey, streamCallback, allowResponse, {
  ...
  for (let i = 0; i < retries; i++) {
    ...
    try {
      ...
      const endpoint = providerEndpointUrl(providerEm, model, apiKey);
