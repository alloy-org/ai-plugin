...
import { groceryCountConfirmation, noteContentFromGroceryResponse } from "./functions/groceries"
  ...
  noteOption: {
    ...
    "Sort Grocery List": {
      ...
      run: async function(app, noteUUID) {
        ...
        const listItemCount = (startContent.match(/^- \[ \\]/g) || []).length;
        const confirmation = groceryCountConfirmation.bind(this, listItemCount);
        let sortedListContent = await this._notePromptResponse(app, noteUUID, "sortGroceries", {},
