import { AI_MODEL_LABEL, MAX_RESPONSE_CHOICES } from "./constants"
import { sendQuery } from "./plugin-fetch"
...
const plugin = {
  ...
  async _noteOptionInsertContent(app, noteUUID, promptKey, promptParams, { confirmInsert = false, rejectedResponses = null } = {}) {
    ...
    const result = await sendQuery(this, app, promptKey, { ...promptParams, noteContent }, rejectedResponses);
