  ...
  noteOption: {
    ...
    "Sort Grocery List": {
      ...
      run: async function(app, noteUUID) {
        ...
        const jsonGroceries = await notePromptResponse(this, app, noteUUID, "sortGroceries", { groceryArray },
          { allowResponse: confirmation });
        if (typeof(jsonGroceries) === "object") {
          const listContent = noteContentFromGroceryResponse(jsonGroceries)
          app.replaceNoteContent({ uuid: noteUUID }, listContent);
        }
      }
    },
