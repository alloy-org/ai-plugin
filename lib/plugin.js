...
import { aiModelFromUserIntervention } from "./model-picker"
import { notePromptResponse, recommendedAiModels, sendQuery } from "./model-picker"
import { apiKeyFromApp, apiKeyFromAppOrUser } from "./ai-provider-settings"
...
const plugin = {
  ...
  appOption: {
    // --------------------------------------------------------------------------
    "Add Provider API key": async function(app) {
      await aiModelFromUserIntervention(this, app, { defaultProvider: null });
    },
