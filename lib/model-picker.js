import { NO_MODEL_FOUND_TEXT, OLLAMA_INSTALL_TEXT, OPENAI_API_KEY_TEXT } from "constants/prompt-strings"
import {
...
export function responseFromPrompts(plugin, app, aiModel, promptKey, messages, { allowResponse = null } = {}) {
  if (isModelOllama(aiModel)) {
    return callOllama(plugin, app, aiModel, messages, promptKey, allowResponse);
  } else {
