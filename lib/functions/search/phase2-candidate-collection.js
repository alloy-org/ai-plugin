...
export async function phase2_collectCandidates(searchAgent, criteria) {
  ...
  // Step 2.2: Calculate keyword density estimate for each candidate
  // Uses full keyword lists to ensure consistent scoring regardless of which keyword matched
  ...
  // Step 2.5: Sort by keyword density estimate (highest density first)
  candidates.sort((a, b) => {
