...
async function upsertCandidate(candidatesByUuid, noteHandle, searchAgent, increment = 1) {
  ...
  console.log(`Created searchCandidate with ${ noteContent.length } content in ${ new Date() - startAt }ms from`, noteHandle, "and typeof content", typeof noteHandle.content);
