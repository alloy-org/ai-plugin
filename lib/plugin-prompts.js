...
export async function buildPromptsAndCallOpenAI(plugin, app, promptKey, promptParams, rejectedResponses = null) {
 ...
 */
function promptsFromPromptKey(promptKey, promptParams, rejectedResponses) {
  let messages = [];
